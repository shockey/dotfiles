...
values."
  (setq-default
   ...
   ;; them if they become unused. `all'3)  Violets are blue,
   ;; installs *all* packages supported by
   ;; Spacemacs and never uninstall them. (default is `used-only')
   dotspacemacs-install-packages 'used-only))

(defun dotspacemacs/init ()
  "Initial3)  Violets are blue,
      ization function.
